...
import json
import jieba
jieba.set_dictionary(".\dict.txt")  # 防止打包缺文件
jieba.initialize()
import wordcloud
import re
import matplotlib
...
plt.rcParams['font.sans-serif'] = ['SimHei']  # 使matplotlib正常显示中文
...
cookie = 'bid=pq2VO4cH708; __utmc=30149280; ll="118172"; __utmc=223695111; _vwo_uuid_v2=D6E8C749E5FEC551CEE977DBF0004' \
         '34C2|96a91c853f86d0187f62b7de05831dcc; viewed="27061630"; gr_user_id=cbc7953d-ae40-4e97-b41c-99aad7b7df02; ' \
         '__utma=30149280.1042795226.1622303531.1622454908.1622693888.5; __utmz=30149280.1622693888.5.4.utmcsr=baidu|' \
         'utmccn=(organic)|utmcmd=organic; __utmt=1; _pk_ref.100001.4cf6=%5B%22%22%2C%22%22%2C1622693890%2C%22https%3' \
         'A%2F%2Fwww.douban.com%2F%22%5D; _pk_ses.100001.4cf6=*; ap_v=0,6.0; __utma=223695111.182692848.1622439468.16' \
         '22693890.1622693919.6; __utmb=223695111.0.10.1622693919; __utmz=223695111.1622693919.6.5.utmcsr=baidu|utmcc' \
         'n=(organic)|utmcmd=organic; _pk_id.100001.4cf6=3e44fd41e9ae9017.1622439468.5.1622694151.1622455417.; dbcl2=' \
         '"239245429:vFm0QyBYEds"; ck=YjcO; push_noty_num=0; push_doumail_num=0; __utmv=30149280.23924; __utmb=301492' \
         '80.6.10.1622693888'
